				...
				<section className="dashboard-col left-col">
					...
					<div className="card-minimal info-box">
						...
						<p className="bio-text">
							Passionate MERN stack developer skilled in JavaScript, React.js,
							Node.js, Express.js, and MongoDB. Committed to writing clean,
							maintainable code and continuously expanding knowledge. Driven by
							a desire to contribute to cutting-edge projects, eager to gain
							diverse industry experience in crafting modern web applications
							alongside talented teams. Expert in Next.js and Strapi CMS
							headless environments.
						</p>
						<div className="contact-info-list">
							<div className="contact-item">
								<Mail size={14} className="icon-sub" />
								<a href="mailto:rishkv923@gmail.com" className="contact-link">
									rishkv923@gmail.com
								</a>
							</div>
							<div className="contact-item">
								<Phone size={14} className="icon-sub" />
								<a href="tel:+917907392365" className="contact-link">
									+91 7907392365
								</a>
							</div>
							<div className="contact-item">
						...
						<div className="education-list">
							{educations.map((edu, idx) => (
								<div
									...
									className="edu-item"
									style={{
										marginBottom: idx === educations.length - 1 ? 0 : "16px",
									}}
								>
									<div
										style={{
							...
							<div>
								...
								<div className="tags-flex">
									{skills.languages.map((s) => (
										<span key={s} className="minimal-tag">
											{s}
										</span>
									))}
								</div>
								...
								<div key={index} className="job-item">
									<div className="job-header">
										<div>
											...
											<span className="job-company-text">
												{job.company} —{" "}
												<span
													style={{
														fontSize: "0.8rem",
						...
						<div className="projects-flex">
							{mainProjects.map((proj, index) => (
								<div key={index} className="project-item-min">
									...
									<p
										className="project-desc-min"
										style={{marginBottom: "10px"}}
									>
										{proj.desc}
									</p>
									<ul
										className="job-bullet-list"
										style={{marginTop: "4px", marginBottom: "8px"}}
									>
										{proj.bullets.map((b, idx) => (
											<li
												key={idx}
												className="job-bullet-item"
										...
										>
											...
											{proj.link && (
												<a
													...
													target="_blank"
													rel="noopener noreferrer"
													className="project-link-min"
													aria-label={`View Live Link for ${proj.title}`}
												>
